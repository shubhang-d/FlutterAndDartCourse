...
import 'package:expensetrackerapp/widgets/expenses_list/chart/chart.dart';
...
class _ExpensesState extends State<Expenses>{
  final List<Expense> _registeredExpenses = [
    Expense(title: "App Store Fee", amount: 25.0, date: DateTime.now(), category: Category.work)
  ];
